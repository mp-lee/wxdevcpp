object MainForm: TMainForm
  ...
  object ControlBar1: TControlBar
    ...
    object tbProject: TToolBar
      ...
      object ProjectProfileCmb: TComboBox
        Left = 85
        Top = 0
        Width = 162
        Height = 21
        ...
        ItemHeight = 13
        TabOrder = 0
        OnChange = ProjectProfileCmbChange
      end
    end
  ...
  object XPMenu: TXPMenu
    ...
    FlatMenu = False
    AutoDetect = True
    XPControls = [xcMainMenu, xcPopupMenu, xcToolbar, xcControlbar, xcCombo, xcListBox, xcEdit, xcMaskEdit, xcMemo, xcRichEdit, xcMiscEdit, xcCheckBox, xcRadioButton, xcButton, xcBitBtn, xcSpeedButton, xcUpDown, xcPanel, xcTreeView, xcProgressBar, xcHotKey]
    Active = False
    Left = 464
    Top = 158
  end
